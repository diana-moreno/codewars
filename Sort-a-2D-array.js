...
function namesSorter (arr) {
  return arr.join().split(",").sort((a, b) => a.length - b.length || a.localeCompare(b))
}

var departmentsArray = [["Pablo", "Enrique", "Josh", "Juan", "Gonzalo"], ["Michael", "Alexander", "Mikel", "Ariel"], ["John", "Julia", "Brad", "George"]];
